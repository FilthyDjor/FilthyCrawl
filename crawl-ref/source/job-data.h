...
{ JOB_ARCANE_MARKSMAN, {
    ...
    WCHOICE_RANGED,
    { { SK_FIGHTING, 3 }, { SK_DODGING, 2 }, { SK_SPELLCASTING, 2 },
...
{ JOB_ARCHAEOLOGIST, {
    ...
    WCHOICE_NONE,
    { { SK_STEALTH, 3}, { SK_DODGING, 3}, { SK_FIGHTING, 3}, { SK_WEAPON, 3} },
} },
...
{ JOB_ARTIFICER, {
    ...
    WCHOICE_NONE,
    { { SK_EVOCATIONS, 3 }, { SK_DODGING, 3 }, { SK_FIGHTING, 2 },
...
{ JOB_ASSASSIN, {
    ...
    WCHOICE_NONE,
    { { SK_FIGHTING, 3 }, { SK_STEALTH, 4 }, { SK_WEAPON, 3 }, { SK_EVOCATIONS, 2 }, },
} },
...
{ JOB_BERSERKER, {
    ...
    { "animal skin" },
    WCHOICE_PLAIN,
    { { SK_FIGHTING, 4 }, { SK_DODGING, 4 }, { SK_WEAPON, 4 }, },
} },
...
{ JOB_CHAOS_KNIGHT, {
    ...
    WCHOICE_PLAIN,
    { { SK_FIGHTING, 3 }, { SK_ARMOUR, 3 }, { SK_DODGING, 3 },
      { SK_WEAPON, 3 } },
} },
...
{ JOB_CONJURER, {
    ...
    WCHOICE_NONE,
    { { SK_CONJURATIONS, 4 }, { SK_SPELLCASTING, 2 }, { SK_DODGING, 3 },
      { SK_STEALTH, 3 }, },
} },
...
{ JOB_EARTH_ELEMENTALIST, {
    ...
    WCHOICE_NONE,
    { { SK_WEAPON, 1 }, { SK_TRANSMUTATIONS, 2 }, { SK_EARTH_MAGIC, 3 }, { SK_SPELLCASTING, 2 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, }
} },
...
{ JOB_ENCHANTER, {
    ...
    WCHOICE_NONE,
    { { SK_WEAPON, 2 }, { SK_HEXES, 3 }, { SK_SPELLCASTING, 2 },
...
{ JOB_FIRE_ELEMENTALIST, {
    ...
    WCHOICE_NONE,
    { { SK_CONJURATIONS, 3 }, { SK_FIRE_MAGIC, 3 }, { SK_SPELLCASTING, 2 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, },
} },
...
{ JOB_GLADIATOR, {
    ...
    WCHOICE_GOOD,
    { { SK_FIGHTING, 3 }, { SK_THROWING, 3 }, { SK_DODGING, 3 },
      { SK_WEAPON, 3}, },
} },
...
{ JOB_HUNTER, {
    ...
    WCHOICE_RANGED,
    { { SK_FIGHTING, 2 }, { SK_DODGING, 2 }, { SK_STEALTH, 4 },
      { SK_WEAPON, 4 }, },
} },
...
{ JOB_ICE_ELEMENTALIST, {
    ...
    WCHOICE_NONE,
    { { SK_CONJURATIONS, 3 }, { SK_ICE_MAGIC, 3 }, { SK_SPELLCASTING, 2 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, },
} },
...
{ JOB_NECROMANCER, {
    ...
    WCHOICE_NONE,
    { { SK_SPELLCASTING, 2 }, { SK_NECROMANCY, 4 }, { SK_DODGING, 3 },
      { SK_STEALTH, 3 }, },
} },
...
{ JOB_REAVER, {
    ...
    WCHOICE_GOOD,
    { { SK_FIGHTING, 3 }, { SK_DODGING, 3 }, { SK_SPELLCASTING, 3 },
      { SK_WEAPON, 3}, },
} },
...
{ JOB_SUMMONER, {
    ...
    WCHOICE_NONE,
    { { SK_SUMMONINGS, 4 }, { SK_SPELLCASTING, 2 }, { SK_DODGING, 3 },
      { SK_STEALTH, 3 }, },
} },
...
{ JOB_TRANSMUTER, {
    ...
    WCHOICE_NONE,
    { { SK_FIGHTING, 3 }, { SK_WEAPON, 3 }, { SK_DODGING, 2 },
...
{ JOB_VENOM_MAGE, {
    ...
    WCHOICE_NONE,
    { { SK_CONJURATIONS, 2 }, { SK_POISON_MAGIC, 4 }, { SK_SPELLCASTING, 2 },
      { SK_DODGING, 2 }, { SK_STEALTH, 2 }, },
} },
...
{ JOB_WARPER, {
    ...
    { { SK_FIGHTING, 2 }, { SK_DODGING, 2 }, { SK_SPELLCASTING, 2 },
      { SK_TRANSLOCATIONS, 4 }, { SK_WEAPON, 2 }, },
} },
...
{ JOB_WIZARD, {
    ...
    WCHOICE_NONE,
    { { SK_DODGING, 1 }, { SK_STEALTH, 1 }, { SK_SPELLCASTING, 4 },
      { SK_TRANSLOCATIONS, 2 }, { SK_CONJURATIONS, 2 }, { SK_SUMMONINGS, 2 }, },
} },
